...
import { UserRole, AIResponse } from "../types";
...
export async function processUserRequest(
  ...
  const ai = getAI();
  // Se for Executivo, usa o modelo mais potente
  const modelName = role === UserRole.AFFILIATE_EXEC ? 'gemini-3-pro-preview' : 'gemini-3-flash-preview';
